...
import { ArrowLeft, Filter, RotateCcw, Sun, Moon, ShieldCheck } from 'lucide-react';
                                    ...
                                    return (
                                        <tr key={idx} className="log-row">
                                            ...
                                            <td style={{ padding: '1rem' }}>
                                                <div style={{ maxHeight: '4em', overflow: 'hidden', fontFamily: 'monospace', fontSize: '0.85rem', lineHeight: '1.5', whiteSpace: 'normal', wordBreak: 'break-word', display: '-webkit-box', WebkitLineClamp: 3, WebkitBoxOrient: 'vertical' }}>
                                                    {log.log_message}
                                                </div>
                                            </td>
                                            <td style={{ padding: '1rem' }}>
